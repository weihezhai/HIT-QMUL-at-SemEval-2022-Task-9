...
'''
batchsize = 4
model, tokenizer = get_premodel(type='Bart', path=r"/data/home/acw664/experiment/Bart/Bart_Large_Model")
...
# special_tokens_dict = {'additional_special_tokens': ['[BOH]', '[EOH]', '[IOH]']}
# tokenizer.add_special_tokens(special_tokens_dict)
# model.resize_token_embeddings(len(tokenizer))
# /data/home/acw664/experiment/datas/data1/data
train_dataloader, validation_dataloader = get_dataloader(tokenizer,
                                                         ...
                                                         train_text_path_entity=r"/data/home/acw664/experiment/datas/data1/entity/train3.json",
                                                         ...
                                                         val_text_path_entity=r"/data/home/acw664/experiment/datas/data1/entity/val3.json",
                                                         batchsize=batchsize)
