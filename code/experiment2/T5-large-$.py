...
# 加载模型
def get_premodel(type="T5", path=r"D:\Anaconda\learn\_Bert\pre_train_model\t5-small"):
    '''
    :param path: 预训练模型在本机的路径
    :return:
    '''
    if type == "Bart":
        model = BartForConditionalGeneration.from_pretrained(path, forced_bos_token_id=0)
...
def train(model, tokenizer, train_dataloader, validation_dataloader, epochs=10,
    ...
    for epoch in range(epochs):
        ...
        if epoch >= 3 and np.mean(test_acc)>best_val_acc:
          ...
          #  s_path = save_path
            sub_path = save_path#os.path.join(s_path, "model")
        ...
        print("{}  Train_loss: {}----Test_loss:{} Test_acc:{} len(test):{}".format(epoch, np.mean(train_loss),
                                                                                   np.mean(test_loss),
...
model type
model path
学习率  T5:2e-4  Bart:2e-5

data path
'''
batchsize = 4
model, tokenizer = get_premodel(type='T5', path=r"/data/home/acw664/number_reasoning/t5")
# T5-large :  /data/home/acw664/number_reasoning/t5
# T5-base :/data/home/acw664/experiment/T5/T5-base
# Bart_base:/data/home/acw664/experiment/Bart/Bart_Base_Model
# Bart-large:/data/home/acw664/experiment/Bart/Bart_Large_Model

#special_tokens_dict = {'additional_special_tokens': ['[BOH]', '[EOH]']}
...
train_dataloader, validation_dataloader = get_dataloader(tokenizer,
                                                         ...
                                                         train_text_path=r"/data/home/acw664/experiment/datas/data3/data/train3.json",
                                                         train_text_path_entity=r"/data/home/acw664/experiment/datas/data3/entity/train3.json",

                                                         val_qa_path="/data/home/acw664/experiment/datas/QAs/val_qa.json",
                                                         val_text_path=r"/data/home/acw664/experiment/datas/data3/data/val3.json",
                                                         val_text_path_entity=r"/data/home/acw664/experiment/datas/data3/entity/val3.json",
                                                         batchsize=batchsize)
