...
class myDataset(Dataset):
    ...
    def __getitem__(self, index):
        ...
        qs = item.question.values
        ans = item.answer.values
        texts = item.context.values
...
for epoch_i in range(0, epochs):
    ...
    input_ids, attention_masks, labels = myDataset(data, tokenizer)
    ...
    avg_val_accuracy = np.mean(total_eval_accuracy)
